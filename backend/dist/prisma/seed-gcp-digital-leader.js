...
async function main() {
    console.log('Seeding Google Cloud Digital Leader exam questions...');
    try {
        ...
        if (!exam) {
            console.error('Google Cloud Digital Leader sınavı bulunamadı!');
            return;
        }
        ...
        for (const q of digitalLeaderQuestions) {
        ...
        console.log(`Added ${digitalLeaderQuestions.length} questions to the exam.`);
...
//# sourceMappingURL=seed-gcp-digital-leader.js.map